...
const ProfilDataBuku = ({ datas }) => {
        ...
        return datas.length > 0 ? (
            datas.map((data, i) => (
                <Table.TrBody key={i} className="text-xs">
                    ...
                    <Table.Td>{data.penerbit}</Table.Td>
                    <Table.Td>{data.tahun}</Table.Td>
                    <Table.Td>{data.isbn}</Table.Td>
    ...
    return (
        <Table>
            <Table.Thead>
                <Table.TrHead>
                    <Table.Th height={25} width={55}>
                        judul
                    </Table.Th>
                    <Table.Th height={25} width={25}>
                        penerbit
                    </Table.Th>
                    <Table.Th height={25} width={7}>
                        tahun
                    </Table.Th>
                    <Table.Th height={25} width={13}>
                        isbn
                    </Table.Th>
